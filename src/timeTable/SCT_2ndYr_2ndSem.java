 ...
 * @author Madushka
 */
public class SCT_2ndYr_2ndSem extends javax.swing.JFrame {

    /**
     * Creates new form SCT_2ndYr_2ndSem
     */
    public SCT_2ndYr_2ndSem() {
        initComponents();
    ...
    private void initComponents() {
        ...
        sct22Query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT s FROM Sct22 s");
        sct22List = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : sct22Query.getResultList();
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, sct22List, jTable1);
        ...
        jLabel1.setText("Science & Technology Department");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SCT_2ndYr_2ndSem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SCT_2ndYr_2ndSem().setVisible(true);
            }
        });
    }
    ...
    private java.util.List<timeTable.Sct22> sct22List;
    private javax.persistence.Query sct22Query;
